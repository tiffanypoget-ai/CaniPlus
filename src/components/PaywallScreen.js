    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '24px 20px' }} className="screen-content">
        ...
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <div style={{ fontSize: 22, fontWeight: 900, color: 'var(--ink)', marginBottom: 6 }}>
        ...
        {/* Ce qui est inclus */}
        <div style={{ background: 'var(--gray-bg)', borderRadius: 20, padding: '16px 18px', marginBottom: 24 }}>
          <div style={{ fontSize: 12, fontWeight: 800, color: 'var(--gray)', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 12 }}>
            Ce qui est inclus
          </div>
          {INCLUS.map((item, i) => (
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 16, marginBottom: 20 }}>
          {[
            ...
            <div key={b.text} style={{ fontSize: 11, color: 'var(--gray-mid)', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 4 }}>
