...
//   - iOS Safari : affiche les instructions (Partage > Ajouter a l'ecran d'accueil).
...
function detectPlatform() {
  ...
  // Tablette / desktop : on ne propose pas l'install
  return 'desktop';
}
...
export default function InstallAppBanner() {
  ...
  const handleInstall = async () => {
    ...
    if (deferredPrompt) {
      ...
      // Pas d'event capture (Android sans support, ou navigateur autre) : aide iOS-like
      setShowIosHelp(true);
    }
  };
